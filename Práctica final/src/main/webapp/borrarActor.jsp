...
<!DOCTYPE html>
        ...
        <%
            ...
            actores = bd.recuperarTodosLosActores();
        %>
...
<html>
    ...
    <body>
        ...
        <div class="container">
            ...
            <h1>Elimina un actor.</h1>
            <p>También se eliminará del reparto de las películas donde actúa.</p>
            <br><br>
            ...
            <table class="table table-striped">
                <thead>
                    <tr>
                        ...
                        <th width="75%" scope="col">Actor</th>
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td><h3><%= nombre%></h3></td>
                        <td>
                            <form action="BorrarActor" method="POST">
                                <input type="hidden" name="actor" value="<%= nombre%>">
