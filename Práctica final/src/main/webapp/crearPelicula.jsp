            ...
            <form action="CargarPelicula" method="POST" onsubmit="cargar()">
                <table>
                    <tr>
                        ...
                        <td><input type="text" pattern="[0-9a-zA-ZÀ-ÿ ñÑ-\.,]{0,50}" size="40" name="nombrePelicula" required></td>
                    </tr>
                    <tr>
                        <td width="500px"><p>Sinopsis:</p></td>
                        <td><input type="text" pattern="[0-9a-zA-ZÀ-ÿ ñÑ-\.,]{0,1000}" size="40" name="sinopsis" required></td>
                    </tr>
                    <tr>
                        <td width="500px"><p>Página web oficial:</p></td>
                        <td><input type="url" size="40" name="pagina_oficial" required></td>
                    </tr>
                    <tr>
                        <td width="500px"><p>Título original:</p></td>
                        <td><input type="text" pattern="[0-9a-zA-ZÀ-ÿ ñÑ-\.,]{0,50}" size="40" name="titulo_original" required></td>
                    </tr>
                    <tr>
                        <td width="500px"><p>Género:</p></td>
                        <td><input type="text" pattern="[0-9a-zA-ZÀ-ÿ ñÑ-\.,]{0,50}" size="40" name="genero" required></td>
                    </tr>
                    <tr>
                        <td width="500px"><p>Nacionalidad:</p></td>
                        <td><input type="text" pattern="[0-9a-zA-ZÀ-ÿ ñÑ-\.,]{0,50}" size="40" name="nacionalidad" required></td>
                    </tr>
                    <tr>
                        <td width="500px"><p>Duración:</p></td>
                        <td><input type="number" min="0" name="duracion" required> minutos</td>
                    </tr>
                    <tr>
                        <td width="500px"><p>Año:</p></td>
                        <td><input type="number" min="1900" max="2020" name="anyo" required></td>
                    </tr>
                    <tr>
                        <td width="500px"><p>Distribuidora:</p></td>
                        <td><input type="text" pattern="[0-9a-zA-ZÀ-ÿ ñÑ-\.,]{0,50}" size="40" name="distribuidora" required></td>
                    </tr>
                    <tr>
                        <td width="500px"><p>Director:</p></td>
                        <td><input type="text" pattern="[0-9a-zA-ZÀ-ÿ ñÑ-\.,]{0,50}" size="40" name="director" required></td>
                    </tr>
                    <tr>
                        <td width="500px"><p>Clasificación por edad: (0 = todos los públicos)</p></td>
                        <td>No recomendada para menores de <input type="number" min="0" max="18" name="clasificacion_edad" required> años</td>
                    </tr>
                    <tr>
                        <td width="500px"><p>Otros datos:</p></td>
                        <td><input type="text" pattern="[0-9a-zA-ZÀ-ÿ ñÑ-\.,]{0,1000}" size="40" name="otros_datos"></td>
                    </tr>
                    <tr>
                        <td width="500px">
                        ...
                        <td>
                            ...
                            <select id="listaActoresBBDD" name="listaActoresBBDD" size="4" style="width: 200px" required>
